...
public class Teach implements Serializable {
    ...
    @JoinColumn(name = "lecturer", referencedColumnName = "ID", insertable = false, updatable = false)
    ...
    public String toString() {
        ...
        sb.append("Teach");
        sb.append("{course=").append(teachPK.getCourse());
        sb.append("{lecturer=").append(teachPK.getLecturer());
        sb.append("{modifierName=").append(modifierName);
        sb.append("{lecturePractice=").append(lecturePractice);
        sb.append("{needFulfillment=").append(needFulfillment);
        sb.append('}');
        return sb.toString();
    }
